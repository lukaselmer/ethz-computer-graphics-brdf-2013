...
vec3 c2 = vec3(189.0/255.0, 139.0/255.0, 132.0/255.0);
vec3 c3 = vec3(228.0/255.0, 227.0/255.0, 225.0/255.0);
...
vec3 getColor() {
    ...
    for (float i = 0.; i < 10.; i++) {
        c += amplitude * abs(cnoise(frequency * vec3(x + 0.1 * cos(x),y + 0.1 * cos(.1*x),z)));
        amplitude *= 0.4;
        frequency *= 2. + i * 6.;
    }
